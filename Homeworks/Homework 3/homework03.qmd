...
[GitHub Repository](https://github.com/tuo-nome-utente/tuo-repository)
...
rocplot(fitted.soft.opt, leukemia_tst$y, main="Training Data", x= 0.87 , y = 0.45, name = "soft")
...
The final model is a **Soft Margin SVM** with the optimal hyperparameter `r opt_cost`. We will now use this model to classify points into their respective classes. The final results are reported in Table 1. The `leukemia_sd dataset` was used, with a 70/30 split for training and testing, respectively.
