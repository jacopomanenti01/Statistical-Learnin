...
date: 'Released: 20/03/2024. Due: 30/03/2024'
...
* [Quarto reference guide](https://quarto.org/docs/get-started/hello/rstudio.html)
...
The data for this homework are available at [bf.csv](bf.csv).
...
- Explore the data: what is the nature of the response variable (`breast`)? Are there potential issues with any of the predictors? Can you find some useful visualization of the discriminative power of each predictor? Do you need pre-processing or can you proceed with the data set as it is?
...
\end{align*} Discuss the `summary` and the interpretation of the regression coefficients in the context of the study.
